...
(то есть найденный вопрос находится по ключу "questions", а список всех ответов по ключу "answers")
...
При этом в таблицу `answers` вставляется новая строка, связанная по id с таблицей `questions`
...
2. Все пути должны вводиться точно также, как это записано в задании
   (путь с лишними или отсутствующими `/` или грамматическими ошибками работает с неопределённым поведением)
